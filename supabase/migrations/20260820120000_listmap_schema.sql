-- Same logical structure as MySQL listmap (schema.sql).
-- Quoted camelCase columns match the Flask app on the supabase branch.
...
-- Public REST (anon key) cannot read these; Flask uses the Postgres connection.
ALTER TABLE topography ENABLE ROW LEVEL SECURITY;
ALTER TABLE dted ENABLE ROW LEVEL SECURITY;
ALTER TABLE landused ENABLE ROW LEVEL SECURITY;
ALTER TABLE sjung ENABLE ROW LEVEL SECURITY;
ALTER TABLE audit_log ENABLE ROW LEVEL SECURITY;
ALTER TABLE audit_document ENABLE ROW LEVEL SECURITY;
